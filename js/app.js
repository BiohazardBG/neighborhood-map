...
function initMap() {
    ...
    // This autocomplete is for use in the gecoder entry box
    ...
    // Bias the searchbox to within the boubnds of the map
    ...
    drawingManager.addListener('overlaycomplete', function(event) {
        ...
        searchWithinPolygon();
        // compute area in polygon
        computeAreaWithinPolygon();
...
function computeAreaWithinPolygon() {
